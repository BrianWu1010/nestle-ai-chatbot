...
AZ_SEARCH_KEY      = os.getenv("AZURE_SEARCH_KEY")
AZ_SEARCH_ENDPOINT = os.getenv("AZ_SEARCH_ENDPOINT")
assert all([OPENAI_API_KEY, AZ_SEARCH_KEY, AZ_SEARCH_ENDPOINT]), \
    "need OPENAI_API_KEY / AZURE_SEARCH_KEY / AZURE_SEARCH_ENDPOINT in .env"
